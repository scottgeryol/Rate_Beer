...
Brewery.create(name: "Dovetail Brewery", location: "Chicago, IL", beer_id: 2, rating: 8, website: "")
Brewery.create(name: "Other Half Beer Comnpany", location: "Brooklyn, NY", beer_id: 3, rating: 8, website: "")
